...
def main():
    ...
    for n in test_sizes:
        ...
        #1.Linjärsök osorterad, kommer söka hela listan, 
        ...
        #3. Linjärsökning efter 1000 slumpvalda element
        ...
        #6. IndexListQ, lägg in element med kö. 
        idx_q = IndexListQ()
